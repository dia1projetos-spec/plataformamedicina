// MedPlatform V4 - Versão Simplificada e Funcional
...
const translations = {
  pt: {
    loginTitle:'MedPlatform', loginSubtitle:'Plataforma Educacional', email:'Email', password:'Senha', enterButton:'Entrar',
  ...
  es: {
    loginTitle:'MedPlatform', loginSubtitle:'Plataforma Educativa', email:'Correo', password:'Contraseña', enterButton:'Ingresar',
