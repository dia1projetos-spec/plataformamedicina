...
let articles=[], users=[], notifications=[], subjects=[], permissions=[], posts=[], feedPermissions=[], payments=[];
    ...
    <main class="max-w-6xl mx-auto px-6 py-10">
      <div class="glass rounded-3xl shadow-modern p-10 border-t-8 border-blue-500 mb-8">
        ...
        <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
          <div>
            <label class="block text-sm font-bold mb-2">Chave PIX</label>
            <input type="text" id="pix-key" class="w-full px-4 py-3 border-2 border-gray-200 rounded-xl" value="${pixConfig.pixKey || ''}" placeholder="cole@seuemail.com" />
          </div>
          <div>
